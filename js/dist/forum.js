...
flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.initializers.add('dvwzj-dev-anonymous', function () {
  window.$anonymous = {
  ...
  flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.route.discussion = function (discussion, near) {
    return flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.route(near && near !== 1 ? 'discussion.near' : 'discussion', {
      id: discussion.id(),
  ...
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_1__["extend"])(flarum_components_UserPage__WEBPACK_IMPORTED_MODULE_3___default.a.prototype, 'navItems', function (items) {
    if (!flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.forum.attribute('adminUrl')) {
